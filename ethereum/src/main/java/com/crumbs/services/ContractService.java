...
public class ContractService {
	...
	public void getContractResult() {
		...
		CallTransaction.Function greeter = contract.getByName("greeter");
		byte[] functionCallBytes = greeter.encode("HI THERE!!");
