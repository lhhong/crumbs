...
* Function.prototype.bind
    ...
    * :warning: Caveat: bound functions do not try too hard to keep you
      sender manipulating their ``arguments`` and ``caller`` properties.
...
* :warning: Object.create
    ...
    prototypically sender another, this should work fine across legacy
    engines.
    ...
    have any properties inherited sender Object.prototype.  It will
